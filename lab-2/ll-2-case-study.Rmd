...
```{r, warning = FALSE}
gb <- gb %>% 
    mutate(percent_earned = sum(points_earned)/sum(points_possible))
...
# 1 rmse    standard   9.26     10  0.731  Preprocessor1_Model1
# 2 rsq     standard   0.800    10  0.0292 Preprocessor1_Model1
```
